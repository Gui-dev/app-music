...
export default defineConfig({
	...
	resolve: {
		alias: {
			...
			'react-native-safe-area-context': resolve(mockDir, 'react-native-safe-area-context/index.js'),
			'@expo/vector-icons': resolve(mockDir, '@expo/vector-icons.js'),
			'nativewind': resolve(mockDir, 'nativewind.js'),
			'react-native-css-interop': resolve(mockDir, 'react-native-css-interop.js'),
