...
describe('MusicRepository', () => {
  ...
  it('should search musics by title, artist, or album', async () => {
    ...
    await repo.save(createTestMusic({ id: '1', title: 'Yellow Submarine', artist: 'The Beatles', album: 'Yellow Submarine' }))
    await repo.save(createTestMusic({ id: '2', title: 'Hey Jude', artist: 'The Beatles', album: 'Hey Jude' }))
    await repo.save(createTestMusic({ id: '3', title: 'Bohemian Rhapsody', artist: 'Queen', album: 'A Night at the Opera' }))
